...
function getEulaText(chat_id) {
    ...
    return `Hi! I'm the ITF Trading Bot. Before you activate your account you MUST accept the Terms of Use. [Click here to accept.](https://t.me/iv?url=https%3A%2F%2F${eula_endpoint}%2Feula%3Fu%3D${chat_id}&rhash=${rhash})`
}